                    ...
                    <ul> 
                        ...
                        <li> 
                            ...
                            <ul class="child-menu"> 
                                ...
                                <li> <a href="http://www.lacaja.com.pe/web/guest/mision-y-vision" >Misión y Visión</a> </li> 
                                ...
                                <li> <a href="http://www.lacaja.com.pe/web/guest/gestion-administracion-y-finanzas" >Gestión-Gerencia de Administración y Finanzas</a> </li> 
                                <li> <a href="http://www.lacaja.com.pe/web/guest/gestion-gerencia-de-pension" >Gestión - Gerencia de Pensiones</a> </li> 
                                <li> <a href="http://www.lacaja.com.pe/web/guest/organizacion" >Organización</a> </li> 
                                <li> <a href="http://www.lacaja.com.pe/web/guest/trabaja-con-nosotros" >Trabaja con Nosotros</a> </li> 
                            </ul> 
                        </li> 
                        <li> 
                            <a href="http://www.lacaja.com.pe/web/guest/orientacion-al-usuario" ><span> Orientación al Usuario</span></a> 
                            <ul class="child-menu"> 
                        ...
                        <li> 
                            ...
                            <ul class="child-menu"> 
                                <li> <a href="http://www.lacaja.com.pe/web/guest/legislacion" >Legislación</a> </li> 
                                                                ...
                                                                <c:forEach items="${benef}" var="benef">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="north" style="background-color:#31659C; left: 0px; top: 0px; width: 450px; height: 27px;">                                                            
                                                                                <div style="margin-top:0.5em;padding-left: 0.6em;color: #FFF;height: 1em;">		
                                                                                    Código: <strong>${benef.CODPER}</strong>		
                                                                                </div>                                                                
                                                                            </div>
                                                                        </td>
                                                                    </tr>
